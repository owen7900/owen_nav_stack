...
private:
  void
  destination_callback(roomba_msgs::msg::MultifloorPoint::ConstSharedPtr msg);
...
private:
  ...
  rclcpp::Subscription<roomba_msgs::msg::MultifloorPoint>::SharedPtr
      destination_sub;

  rclcpp::Client<roomba_msgs::srv::GetPathObstacles>::SharedPtr
      path_obstacles_srv;
  rclcpp::Client<roomba_msgs::srv::CanContinue>::SharedPtr continue_srv;
  rclcpp::Client<roomba_msgs::srv::GetElevatorPosition>::SharedPtr
      elevator_pos_srv;
